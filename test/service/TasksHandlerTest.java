...
class TasksHandlerTest {
    ...
    public void testGetAllTasks() throws IOException, InterruptedException {
        ...
        Task task2 = new Task("Task 2", "Description 2", Status.NEW, Duration.ofMinutes(20), LocalDateTime.now().plusMinutes(11));
    ...
    public void testGetTaskById() throws IOException, InterruptedException {
        Task task = new Task("Test Task", "Testing task retrieval", Status.NEW, Duration.ofMinutes(5), LocalDateTime.now());
